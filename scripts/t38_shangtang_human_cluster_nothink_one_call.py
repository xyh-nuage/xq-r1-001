...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit("usage: t38_shangtang_human_cluster_nothink_one_call.py SOURCE_ROOT OUTPUT_DIR")
    ...
    # Single experimental variable vs t37: disable thinking. Still omit max_tokens.
    request_body = {
        "model": model,
        "messages": [
    ...
    try:
        ...
        failure = {
            "schema_version": "research_full_context_human_cluster_nothink_raw_result.v1",
