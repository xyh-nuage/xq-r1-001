...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit("usage: t45_shangtang_compact_first48_low1800_retry429.py SOURCE_ROOT OUTPUT_DIR")
    ...
    for attempt in (1, 2):
        ...
        try:
            ...
            if int(exc.code) == 429 and attempt == 1:
                ...
                continue
            raw = {
                "schema_version": "research_full_context_first48_low1800_raw_result.v1",
    ...
    print("full_packet_chars=" + str(len(full_packet)))
