...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit("usage: t36_shangtang_human_cluster_one_call.py SOURCE_ROOT OUTPUT_DIR")
    ...
    # This is still the registry-free full-context reconstruction baseline.
    ...
    try:
        ...
        failure = {
            "schema_version": "research_full_context_human_cluster_raw_result.v1",
    ...
    # Persist raw result before any reference is opened.
