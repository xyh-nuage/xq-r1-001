...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit("usage: t43_shangtang_compact_medium_max3000_retry429.py SOURCE_ROOT OUTPUT_DIR")
    ...
    for attempt in (1, 2):
        ...
        try:
            ...
            if int(exc.code) == 429 and attempt == 1:
                ...
                continue
            failure = {
                "schema_version": "research_full_context_compact_medium_raw_result.v1",
